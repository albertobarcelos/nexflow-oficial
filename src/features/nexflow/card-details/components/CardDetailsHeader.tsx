  ...
  return (
    <div className="px-8 py-6 border-b border-slate-100 dark:border-slate-800 shrink-0">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-8 pr-12 overflow-visible">
          <CardPipelineStages 
            steps={steps} 
          ...
          <button
            onClick={onClose}
            className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full transition-colors text-slate-400 dark:text-slate-500 flex-shrink-0"
          >
            <X className="h-6 w-6" />
          </button>
        </div>
