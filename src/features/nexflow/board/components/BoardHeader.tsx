...
export function BoardHeader({
  ...
  return (
    <header className="bg-white  border-b border-neutral-200  px-6 py-3 flex flex-col md:flex-row md:items-center justify-between gap-4 shrink-0">
      ...
      <div className="flex items-center gap-3">
        <Button
          ...
          size="sm"
          onClick={onGoBack}
          className="flex items-center gap-1 text-xs font-medium text-neutral-400 hover:text-neutral-600 :text-neutral-300 transition-colors px-2 h-auto"
        >
