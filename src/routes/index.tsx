...
import { FlowDashboardPage } from "@/pages/crm/flows/FlowDashboardPage";
...
const ResellerDashboard = () => (
  <div>Reseller Dashboard - Em desenvolvimento</div>
);
const ResellerClients = () => <div>Reseller Clients - Em desenvolvimento</div>;
const ResellerClientNew = () => (
  <div>Reseller Client New - Em desenvolvimento</div>
);
const ResellerCommissions = () => (
  <div>Reseller Commissions - Em desenvolvimento</div>
);
const ResellerReports = () => <div>Reseller Reports - Em desenvolvimento</div>;
const ResellerSettings = () => (
  <div>Reseller Settings - Em desenvolvimento</div>
);
